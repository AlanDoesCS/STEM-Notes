...
*Product notation* is similar to sigma notation, as it represents a repeated operation, but it denotes multiplication rather than summation. For example, the product:
